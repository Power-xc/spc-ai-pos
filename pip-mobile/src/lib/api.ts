...
const mockAlarmCards: AlarmCard[] = [
  ...
  { id: "ALT-007", code: "ALT-007", categories: ["Agent"], datetime: "발생일시 발생 13:10", title: "주문관리 에이전트 주문 미급 추천", description: "최근 20분 간 Agent 분석 후 추가 주문 추천이 발생했을 경우 알림", condition: "조건: 재고 20개 한  Push", tags: ["Push"], enabled: true },
